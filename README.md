# Perudo-QD
#Progetto di gruppo (4 developers), ancora in fase iniziale.
...
- Lo script dado.py contiene la classe Dado e il codice che simula il lancio di un dado.
- Lo script giocatore.py contiene la classe Giocatore.
